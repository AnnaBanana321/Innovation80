...
library(ggplot2)
ggplot(scale_data, aes(x = Survey.Type, y = `Collab.Enjoyment`, fill = Survey.Type)) +
  geom_boxplot() +
...
ggplot(scale_data, aes(x = Survey.Type, y = `Pride.in.Outcome`, fill = Survey.Type)) +
  geom_boxplot() +
...
ggplot(scale_data, aes(x = Participant.Type, y = `Collab.Enjoyment`, fill = Participant.Type)) +
  geom_boxplot() +
...
ggplot(scale_data, aes(x = Participant.Type, y = `Pride.in.Outcome`, fill = Participant.Type)) +
  geom_boxplot() +
